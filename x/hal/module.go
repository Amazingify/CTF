...
import (
	...
	"github.com/cosmos/gaia/v7/x/hal/client/cli"
...
// AppModuleBasic defines the basic application module used by the x/hal module.
...
// AppModule implements an application module for the x/hal module.
...
func (am AppModule) InitModule(ctx sdk.Context, params types.Params) {
	if err := params.Validate(); err != nil {
		panic(fmt.Errorf("x/hal module: InitModule: invalid params: %w", err))
	}
